...
import com.luther.AndrewApp.Data.UpdateCustomer;
import com.luther.AndrewApp.Data.UpdateOrders;
...
public class Customer {
  ...
  public String order(String food, int amt){
      String mess = "";
    if(store.getAmount(food) - amt >= 0){
      if(this.t2*2 + this.t4*4 > 0){
        ...
        mess = "You can't order if you haven't reserve your seats";
        System.out.println("You can't order if you haven't reserve your seats");
      }
    } else {
        mess="The Store only have: " + store.getAmount(food) + " of this item left";
  ...
  public String pay(Restaurant res, int points){
      String mess = "";
    ...
    if(membership[0].equals("1") && Integer.valueOf(membership[1]) > points){
      ...
      mess = "You don't have membership status or you don't have enough membership points";
  ...
  public String reserveTable(Restaurant res, int customers){
      String mess = "";
    if(customers % 4 == 0){
      this.t4 = customers/4;
    }
    ...
    mess = "Tables for 2: " + t2 + ", " + "Tables for 4: " + t4;
